...
for value in range(1,10):
    for variation in range(1,16):
        ...
        filename = "/Data_Tardiness - Case II/p" + str(value) + str(variation) + ".txt"
        p = Read_Data(filename)
        filename = "/Data_Tardiness - Case II/D" + str(value) + str(variation) + ".txt"
        D = Read_Data(filename)
        filename = "/Data_Tardiness - Case II/setup" + str(value) + str(variation) + ".txt"
