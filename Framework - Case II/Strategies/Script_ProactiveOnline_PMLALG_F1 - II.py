def fmain(value, variation):
    ...
    for time_period in range(1,3):
        ...
        print(REFERENCE_MOMENTS_1)
        print(REFERENCE_MOMENTS_2)
        ...
        ampl.read('/Approaches/Proactive-Online approaches/ProactiveOnline_PMLALG_F1.txt')
    ...
    times = open("/Approaches/Proactive-Online approaches/Time_PMLALG_F1.txt","a") 
