def fmain(value, variation):
    ...
    for time_period in range(1,3):
        ...
        if time_period == 1:
            for m in range(1,3):
                ...
                if m == 1:
                    ...
                    if time_period == 1:
                        reference_class_M1 = read_csv('/Approaches/Proactive-Online approaches/DATASET_MACHINE_1_1.csv', header = 0)
                    else:
                        reference_class_M1 = read_csv('/Approaches/Proactive-Online approaches/DATASET_MACHINE_1_2.csv', header = 0)
                    
                    del reference_class_M1['Period']
                    del reference_class_M1['Pressure']
                    del reference_class_M1['Speed']
                    del reference_class_M1['Temperature']
                    del reference_class_M1['Sound']
                    del reference_class_M1['Vibration']

                    tn_M1, fp_M1, fn_M1, tp_M1 = confusion_matrix(reference_class_M1,pred_M1).ravel()
                else:
                    ...
                    if time_period == 1:
                        reference_class_M2 = read_csv('/Approaches/Proactive-Online approaches/DATASET_MACHINE_2_1.csv', header = 0)
                    else:
                        reference_class_M2 = read_csv('/Approaches/Proactive-Online approaches/DATASET_MACHINE_2_2.csv', header = 0)
                    
                    del reference_class_M2['Period']
                    del reference_class_M2['Pressure']
                    del reference_class_M2['Speed']
                    del reference_class_M2['Temperature']
                    del reference_class_M2['Sound']
                    del reference_class_M2['Vibration']

                    tn_M2, fp_M2, fn_M2, tp_M2 = confusion_matrix(reference_class_M2,pred_M2).ravel()
        else:
            for m in range(1,3):
                if m == 1:
                ...
                if m == 1:
                    ...
                    predictions = open("/Approaches/Proactive-Online approaches/Forecastings/Classification_M1_%d.txt" % (time_period),"r") 
                else:
                    ampl.eval('reset data Pressure_M2, Speed_M2, Temperature_M2, Sound_M2, Vibration_M2;')
                    save_predictions(predictions_Pressure, predictions_Speed, predictions_Temp, predictions_Sound, predictions_Vibration)

                    predictions = open("/Approaches/Proactive-Online approaches/Forecastings/Classification_M2_%d.txt" % (time_period),"r")
        ...
        ampl.read('/Approaches/Proactive-Online approaches/ProactiveOnline_PMLALG_F2.txt')
        ...
        while retrain == 1:
            for m in range(1,3):
                ...
                if m == 1:
                    ...
                    predictions = open("/Approaches/Proactive-Online approaches/Forecastings/Classification_M1_%d_%d.txt" % (time_period, counter_retrain),"r") 
                else:
                    ampl.eval('reset data Pressure_M2, Speed_M2, Temperature_M2, Sound_M2, Vibration_M2;')
                    save_predictions(predictions_Pressure, predictions_Speed, predictions_Temp, predictions_Sound, predictions_Vibration)

                    predictions = open("/Approaches/Proactive-Online approaches/Forecastings/Classification_M2_%d_%d.txt" % (time_period, counter_retrain),"r")
    ...
    times = open("/Approaches/Proactive-Online approaches/Time_PMLALG_F2.txt","a") 
