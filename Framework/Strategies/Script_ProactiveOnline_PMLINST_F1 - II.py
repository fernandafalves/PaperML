def fmain(value, variation):
    ...
    for time_period in range(1,3):
        if time_period == 1:
            ampl.eval('reset;')
            ampl.read('/Approaches/Proactive-Online approaches/Data_ProactiveOnline_PMLINST_F1.txt')
        ...
        ampl.read('/Approaches/Proactive-Online approaches/ProactiveOnline_PMLINST_F1.txt')
    ...
    times = open("/Approaches/Proactive-Online approaches/Time_PMLINST_F1.txt","a") 
