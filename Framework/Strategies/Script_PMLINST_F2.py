def fmain(value, variation):
    ...
    for time in range(1,3):            
        if time == 1:
            for m in range(1,3):
                ...
                if m == 1:
                    ...
                    if time == 1:
                        reference_class_M1 = read_csv('/Approaches/Proactive approaches/DATASET_MACHINE_1_1.csv', header = 0)
                    else:
                        reference_class_M1 = read_csv('/Approaches/Proactive approaches/DATASET_MACHINE_1_2.csv', header = 0)
                    ...
                    if time == 1:
                        reference_class_M2 = read_csv('/Approaches/Proactive approaches/DATASET_MACHINE_2_1.csv', header = 0)
                    else:
                        reference_class_M2 = read_csv('/Approaches/Proactive approaches/DATASET_MACHINE_2_2.csv', header = 0)
        ...
        if time == 1:
            ampl.eval('reset;')
            ampl.read('/Approaches/Proactive approaches/Data_PMLINST_F2.txt')
        ...
        for mach in range(1,3):	
            ...
            ampl.read('/Approaches/Proactive approaches/PMLINST_F2.txt')    
