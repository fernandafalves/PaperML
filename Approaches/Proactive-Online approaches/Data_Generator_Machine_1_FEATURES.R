...
df <- data.frame('Period'= PERIOD, 'Pressure' = PRESSURE, 'Speed' = SPEED, 'Temperature' = TEMPERATURE, 'Sound' = SOUND, 'Vibration' = VIBRATION)

write.csv(df,"./DATASET_MACHINE_1_FEATURES.csv", row.names = FALSE)
