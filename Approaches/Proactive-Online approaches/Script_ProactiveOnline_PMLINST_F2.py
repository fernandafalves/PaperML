...
for value in range(1,10):
    for variation in range(1,16):
        ...
        for time_period in range(1,3):
            ...
            if time_period == 1:
                ampl.eval('reset;')
                ampl.read('Data_ProactiveOnline_PMLINST_F2.txt')
            ...
            ampl.read('ProactiveOnline_PMLINST_F2.txt')
            ...
            while retrain == 1:
                if value == 1 and variation == 1:
                    ...
                    for i in range(len(previous_real_failures_1) - (112 - int(subperiod)), len(previous_real_failures_1)):
                        x_input_pred_1.append(previous_real_failures_1[i])

                    for i in range(len(previous_real_failures_2) - (112 - int(subperiod)), len(previous_real_failures_2)):
                    ...
                    for i in range(0,int(subperiod)):
                    ...
                    n_future_pred = 112 - int(subperiod)
        ...
        times = open("Time_PMLINST_F2.txt","a") 
