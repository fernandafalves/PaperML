...
for value in range(1,10):
    for variation in range(1,16):
        ...
        for time_period in range(1,3):
            if time_period == 1:
                ampl.eval('reset;')
                ampl.read('Data_ProactiveOnline_PMLINST_WithoutFeedback.txt')
            ...
            if time_period == 1:
                ...
                if time_period == 2 and value == 1 and variation == 1:
                    for m in range(1,3):
                        ...
                        if m == 1:
                            results_M1 = open("/Forecastings/Forecasting_M1_%d.txt" % (time_period),"w") 
                            ...
                            results_M2 = open("/Forecastings/Forecasting_M2_%d.txt" % (time_period),"w") 
                        ...
                        if m == 1:
                            results_M1 = open("/Forecastings/Classification_M1_%d.txt" % (time_period),"w") 
                            np.savetxt(results_M1, predictions)
                            
                            results_M1.close()
                        else:
                            results_M2 = open("/Forecastings/Classification_M2_%d.txt" % (time_period),"w") 
            ...
            ampl.read('ProactiveOnline_PMLINST_WithoutFeedback.txt')
        ...
        times = open("Time_PMLINST_WF.txt","a") 
