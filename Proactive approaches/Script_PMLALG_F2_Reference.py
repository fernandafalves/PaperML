...
for value in range(1,10):
    for variation in range(1,16):
        ...
        for time in range(1,3):
            if time == 1 and value == 1 and variation == 1:
                ...
                for m in range(1,3):
                    ...
                    if m == 1:
                        pred_M1 = [round(x[0]) for x in predictions]
                        ...
                        if time == 1:
                            reference_class_M1 = read_csv('DATASET_MACHINE_1_1.csv', header = 0)
                        else:
                            reference_class_M1 = read_csv('DATASET_MACHINE_1_2.csv', header = 0)
                        ...
                        pred_M2 = [round(x[0]) for x in predictions]
                        ...
                        if time == 1:
                            reference_class_M2 = read_csv('DATASET_MACHINE_2_1.csv', header = 0)
                        else:
                            reference_class_M2 = read_csv('DATASET_MACHINE_2_2.csv', header = 0)
                ...
                if time == 2 and value == 1 and variation == 1:
                    for m in range(1,3):
                        SEED = 123
                        random.seed(SEED)
                        np.random.seed(SEED)
                        ...
                        # make probability predictions with the model
                        predictions = classification_model.predict(X_class)
                        
                        if m == 1:
                            pred_M1_2 = [round(x[0]) for x in predictions]
                            ...
                            pred_M2_2 = [round(x[0]) for x in predictions]
            ...
            if time == 2 and value == 1 and variation == 1:
                deviation_M1 = len(REFERENCE_MOMENTS_1) - len(MOMENTS_1)
                deviation_M2 = len(REFERENCE_MOMENTS_2) - len(MOMENTS_2)
            ...
            if time == 1:
                ...
                upper_bound_M1 = round(error_M1*fn_M1) 
                upper_bound_M2 = round(error_M2*fn_M2) 
            ...
            Set_Moment_Failures_1.setValues(REFERENCE_MOMENTS_1)
        
            Set_Moment_Failures_2 = ampl.getSet("Set_Moment_Failures_2")
            Set_Moment_Failures_2.setValues(REFERENCE_MOMENTS_2)

            if time == 2:
                deviation_1 = ampl.getParameter("deviation_1")
                deviation_1.set(deviation_M1)

                deviation_2 = ampl.getParameter("deviation_2")
                deviation_2.set(deviation_M2)
